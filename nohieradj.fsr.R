#This function implements the Fast FSR methodology using no hierarchy prinicple
#with adjusted p-values to guide the selection of interactions (and quadratic terms if requested).  



nohieradj.fsr<-function(x,y,gamma0=.05,center=T,maxsteps=kt,print=T,quad=F,digits=4){
require(MASS)

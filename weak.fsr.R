#This function implements the Fast FSR methodology using the weak hierarchy 
#prinicple to guide the selection of interactions (and quadratic terms if requested).  



weak.fsr<-function(x,y,gamma0=.05,center=T,maxsteps=kt,print=T,quad=F,digits=4){
require(MASS)

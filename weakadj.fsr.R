#This function implements the Fast FSR methodology using the weak hierarchy prinicple
#with adjusted p-values to guide the selection of interactions (and quadratic terms if requested).  



weakadj.fsr<-function(x,y,gamma0=.05,center=T,maxsteps=kt,print=T,quad=F,digits=4){
require(MASS)
